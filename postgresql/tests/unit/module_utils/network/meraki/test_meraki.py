...
from ansible_collections.database.postgresql.tests.unit.compat import unittest, mock
...
from ansible_collections.database.postgresql.tests.unit.modules.utils import set_module_args
